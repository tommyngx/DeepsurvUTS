...
def plot_roc_curve(models_to_plot, all_probs_df, time_col, censored_col, threshold=10, title="10-Year ROC Curve", save_folder=None, show_plot=False, keyword=None):
    """
    ...
    if save_folder:
        ...
        save_path = f"{save_folder}/roc_curve_{keyword_str}.png"
